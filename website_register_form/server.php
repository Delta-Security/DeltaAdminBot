...
if (isset($_POST['reg_user'])) {
  ...
  if (empty($host)) { array_push($errors, "FQDN is required (Example: https://ptero.deltasec.systems) (Include http:// or https://)"); }
  if ($api != $api_confirm) {
...
if (isset($_POST['update'])) {
  ...
  if (empty($newhost)) {array_push($errors, "New FQDN is required (Example: https://panel.deltasec.systems) (Include http:// or https://)");}
